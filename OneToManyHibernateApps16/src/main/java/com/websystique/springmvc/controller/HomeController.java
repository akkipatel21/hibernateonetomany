	...
	public String save(@RequestParam("firstname")String firstname,
		...
		// employeeDao.save(employee1);
		 ...
		 employee1.getSubordinates().add(employee1);
			...
			if(((empployee1.getLastname()==lastname)||(empployee1.getEmployeeId()!=null))){
				
				//employee1.setManager(empployee1);
				System.out.println("hieeee====lastname is same then call");
				Employee employee = new Employee(firstname,lastname);
				employee.setManager(empployee1);
				System.out.println("hieeee====lastname is same then call manager id"+empployee1.getManager_id());
				employee.getSubordinates().add(employee);
		        employeeDao.save1(employee);
			}else if(((empployee1.getLastname()!=lastname)||(empployee1.getEmployeeId()!=null))){
				
				System.out.println("hieeee====lastname is notttt same then call");
				Employee employee = new Employee(firstname,lastname);
				employee.setManager(empployee);
				System.out.println("hieeee====lastname is same then call manager id"+empployee.getManager_id());
				employee.getSubordinates().add(employee);
